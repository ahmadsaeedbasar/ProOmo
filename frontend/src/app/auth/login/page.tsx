  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 p-4">
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-xl border border-gray-200">
        <h2 className="text-3xl font-bold text-center text-purple-800 mb-8">Login to ProOmo</h2>
        <Auth
          ...
          appearance={{
            ...
            variables: {
              default: {
                colors: {
                  brand: 'hsl(250 60% 40%)', // A shade of purple
                  brandAccent: 'hsl(250 60% 50%)', // Lighter purple
                },
              },
            },
          }}
          theme="light"
          redirectTo={`${window.location.origin}/auth/callback`} // For OAuth redirects
          view="sign_in"
        />
